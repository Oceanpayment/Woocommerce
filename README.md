...
<ol>
    <li>Upload the Oceanpayment-KOR_Credit Card.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment KOR_Credit Card in the plugin menu.</li>
