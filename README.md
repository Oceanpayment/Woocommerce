...
<ol>
    <li>Upload the Oceanpayment-brcreditcard.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment brcreditcard in the plugin menu.</li>
