...
<ol>
    <li>Upload the Oceanpayment-Rabbit_LinePay.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment Rabbit_LinePay in the plugin menu.</li>
