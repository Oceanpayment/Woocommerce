...
<ol>
    <li>Upload the Oceanpayment-KOR_BankTransfer.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment KOR_BankTransfer in the plugin menu.</li>
