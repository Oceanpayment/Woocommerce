...
<ol>
    <li>Upload the Oceanpayment-Bancontact.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment bancontact in the plugin menu.</li>
