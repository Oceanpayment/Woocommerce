...
<ol>
    <li>Upload the Oceanpayment-KOR_eWallet.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment KOR_eWallet in the plugin menu.</li>
