...
<ol>
    <li>Upload the Oceanpayment-VNM_LPM.zip plug-in in the WordPrwss background.</li>
    <li>Activate oceanpayment VNM_LPM in the plugin menu.</li>
